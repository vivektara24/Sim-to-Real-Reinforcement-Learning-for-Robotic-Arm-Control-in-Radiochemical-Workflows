...
This study aims to trin a robotic arm to perform a multip-step radiochemical seperation process using deep rienforcment learning. As an initial step, the Soft Actor-Critic (SAC) algorithm is implemented to train a policy for pick-and-place operations in simulation.
